<template>
  ...
  >
    ...
    <div class="logo-container">
      <div>
        <q-list>
          <q-collapsible icon="pie_chart" label="Amato">
            <div>
              <h6><b>Horário:</b>12:00</h6>
              <h6><b>Frequência:</b> Diariamente</h6>
              <h6><b>Quantidade restante:</b> 3</h6>
            </div>
          </q-collapsible>
          <q-collapsible icon="pie_chart" label="Primera30">
            <div>
              <h6><b>Horário:</b>12:00</h6>
              <h6><b>Frequência:</b> Diariamente</h6>
              <h6><b>Quantidade restante:</b> 3</h6>
          ...
          <q-collapsible icon="pie_chart" label="Esomeprazol">
            <div>
              <h6><b>Horário:</b>12:00</h6>
              <h6><b>Frequência:</b> Diariamente</h6>
              <h6><b>Quantidade restante:</b> 3</h6>
          ...
          <q-collapsible icon="pie_chart" label="Benegrip">
            <div>
              <h6><b>Horário:</b>12:00</h6>
              <h6><b>Frequência:</b> Diariamente</h6>
              <h6><b>Quantidade restante:</b> 3</h6>
